...
address: "Clark Instruction Center, Watson Library, 1425 Jayhawk Boulevard, Lawrence, KS"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "38.956574"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-95.244782"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "August 14, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2024-08-14      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2024-08-14        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Katherine Hanson", "Brian Sanderson, Ph.D"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Meg Nibbelink", "Greta Valentine", "Erin Wolfe", "Jamene Brooks-Kieffer", "other helpers TBD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2024-08-14-ku-py # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p>This is an <strong>in-person</strong> workshop on KU's Lawrence campus. Registration is open and seats are limited. <a href="https://ku.libwizard.com/f/2024-08-14-ku-py" target="_blank">Register here.</a></p>
...
<p>
  ...
  {% endif %}
  workshop,
  you will need access to an up-to-date web browser. We will access Python, Jupyter Notebooks, and the workshop data through remote computing instances. You do not need to install Python or Jupyter Notebook on your computer.
</p>
